...
class TestAuthorization:
        ...
        def test_successful_authorization(self, registration_page: RegistrationPage,
                ...
                registration_page.visit("https://nikita-filonov.github.io/qa-automation-engineer-ui-"
                                        "course/#/auth/registration")
                registration_page.registration_form.fill_registration_form(email="user.name@gmail.com",
        ...
        def test_navigate_from_authorization_to_registration(self, registration_page: RegistrationPage,
                                                             login_page: LoginPage):
                login_page.visit("https://nikita-filonov.github.io/qa-automation-engineer-ui-course/#/auth/login")
